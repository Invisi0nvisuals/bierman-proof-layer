...
const SHARED_ASSETS = {
  ...
  themeProgressFocused: "/manus-storage/progress_card_no_feet_6b837ce7.png",
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-10">
            {[
              ...
              { title: "Caregiver Training", copy: "Bierman offers caregiver training resources to help families support communication, daily routines, and behavior management at home.", url: "https://www.biermanautism.com/resources/caregiver-training/?utm_source=nj_hub&utm_medium=resource_card&utm_campaign=local_pilot&utm_content=caregiver_training", linkLabel: "Caregiver resources →", icon: <IconABA /> },

...
export const princetonData: LocationData = {
  ...
  assets: {
    ...
    heroImage: "/manus-storage/Princeton,NJ_51e4b2dc.png",
  ...
  schema: {
    ...
    areaServed: [
      ...
      { type: "AdministrativeArea", name: "Bierman Parent", sameAs: "https://en.wikipedia.org/wiki/Hunterdon_County,_New_Jersey" },
      { type: "City", name: "Bierman Parent", sameAs: "https://en.wikipedia.org/wiki/Princeton,_New_Jersey" },

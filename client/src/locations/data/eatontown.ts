...
export const eatontownData: LocationData = {
  ...
  insuranceText:
    "Bierman Eatontown works with a variety of insurance providers. Contact our Intake Team to verify your coverage before your first visit. Horizon BCBS NJ, Aetna, United Healthcare, Cigna, and others are accepted.",
  ...
  nearby: [
    ...
    { name: "Bierman Parent", url: "/locations/nj/berkeley-heights/" },
  ...
  schema: {
    ...
    areaServed: [
      { type: "AdministrativeArea", name: "Bierman Parent", sameAs: "https://en.wikipedia.org/wiki/Monmouth_County,_New_Jersey" },
      { type: "AdministrativeArea", name: "Bierman Parent", sameAs: "https://en.wikipedia.org/wiki/Middlesex_County,_New_Jersey" },
      { type: "AdministrativeArea", name: "Bierman Parent", sameAs: "https://en.wikipedia.org/wiki/Ocean_County,_New_Jersey" },
      { type: "AdministrativeArea", name: "Bierman Parent", sameAs: "https://en.wikipedia.org/wiki/Mercer_County,_New_Jersey" },
      { type: "City", name: "Bierman Parent", sameAs: "https://en.wikipedia.org/wiki/Eatontown,_New_Jersey" },

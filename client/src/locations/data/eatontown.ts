...
export const eatontownData: LocationData = {
  ...
  // ── URLs ──────────────────────────────────────────────────────────────────
  intakeUrl: "https://www.biermanautism.com/start-now/?loc=eatontown-nj&utm_source=local-hub&utm_medium=organic&utm_campaign=nj-pilot&utm_content=eatontown-nj-location-page",

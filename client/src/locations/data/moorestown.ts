...
export const moorestownData: LocationData = {
  ...
  faqs: [
    {
      ...
      a: "The Moorestown center is opening Fall 2026. Families can submit an intake request now to get on our list and be contacted as soon as we are ready to schedule.",
    },
    {
      q: "Where is the Bierman Autism Centers Moorestown clinic located?",
      a: "The Moorestown clinic is located at 505 Pleasant Valley Ave, Moorestown, NJ 08057, serving families in Burlington County, Camden County, and surrounding South Jersey communities.",
    },
    {
  ...
  // ── Nearby ────────────────────────────────────────────────────────────────
  nearby: [
    { name: "Bierman Parent", url: "/locations/nj/princeton/" },
    { name: "Bierman Parent", url: "/locations/nj/cranford/" },
    { name: "Bierman Parent", url: "/locations/nj/piscataway/" },
    { name: "Bierman Parent", url: "/locations/nj/eatontown/" },
  ...
  schema: {
    ...
    areaServed: [
      { type: "AdministrativeArea", name: "Bierman Parent", sameAs: "https://en.wikipedia.org/wiki/Burlington_County,_New_Jersey" },
      { type: "AdministrativeArea", name: "Bierman Parent", sameAs: "https://en.wikipedia.org/wiki/Camden_County,_New_Jersey" },
      { type: "AdministrativeArea", name: "Bierman Parent", sameAs: "https://en.wikipedia.org/wiki/Gloucester_County,_New_Jersey" },
      { type: "AdministrativeArea", name: "Bierman Parent", sameAs: "https://en.wikipedia.org/wiki/Mercer_County,_New_Jersey" },
      { type: "City", name: "Bierman Parent", sameAs: "https://en.wikipedia.org/wiki/Moorestown,_New_Jersey" },

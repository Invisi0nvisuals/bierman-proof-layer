...
export const cranfordData: LocationData = {
  ...
  assets: {
    ...
    heroImage: "/manus-storage/Cranford,NJ_73bda458.png",
    videoPoster: "/manus-storage/bierman-ramsey-video-poster_28eb470d.jpg",
  },

  // ── Schema ────────────────────────────────────────────────────────────────
  schema: {
    pageUrl: "https://bierman-proof-layer.manus.space/locations/nj/cranford/",
    ...
    areaServed: [
      ...
      { type: "City", name: "Bierman Parent", sameAs: "https://en.wikipedia.org/wiki/Cranford,_New_Jersey" },

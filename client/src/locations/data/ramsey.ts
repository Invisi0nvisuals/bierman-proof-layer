...
export const ramseyData: LocationData = {
  ...
  // ── Content ───────────────────────────────────────────────────────────────
  heroDescription:
    "Progress should be something you can see. Our Ramsey team measures your child's growth every day and adjusts quickly, so small wins build into real milestones like communication, independence, and school readiness.",
  insuranceText:
    "Bierman Ramsey works with a variety of insurance providers, including Horizon BCBS NJ, Aetna, United Healthcare, Cigna, and others. Contact our Intake Team to verify your coverage before your first visit.",
  ...
  // ── Schema ────────────────────────────────────────────────────────────────
  schema: {
    pageUrl: "https://local.biermanautism.com/locations/nj/ramsey/",
    baseId: "https://local.biermanautism.com/locations/nj/ramsey/",

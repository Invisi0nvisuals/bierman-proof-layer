...
export const ramseyData: LocationData = {
  ...
  insuranceText:
    "Bierman Ramsey works with a variety of insurance providers. Contact our Intake Team to verify your coverage before your first visit. Horizon BCBS NJ, Aetna, United Healthcare, Cigna, and others are accepted.",
  ...
  schema: {
    ...
    areaServed: [
      { type: "AdministrativeArea", name: "Bierman Parent", sameAs: "https://en.wikipedia.org/wiki/Bergen_County,_New_Jersey" },
      ...
      { type: "AdministrativeArea", name: "Bierman Parent", sameAs: "https://en.wikipedia.org/wiki/Sussex_County,_New_Jersey" },
      { type: "City", name: "Bierman Parent", sameAs: "https://en.wikipedia.org/wiki/Ramsey,_New_Jersey" },
